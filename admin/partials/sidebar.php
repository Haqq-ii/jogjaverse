<aside class="sidebar">
  <div class="brand">JogjaVerse Admin</div>
  ...
  <a class="item" href="<?= BASE_URL ?>/admin/pelaporan.php">Pelaporan</a>

  <a class="item danger" href="<?= BASE_URL ?>/public/logout.php">Sign Out</a>
</nav>
