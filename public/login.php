...
// URL login Google mengikuti redirect_to jika ada (tetap aman).
$google_login_url = BASE_URL . "/public/google-login.php";
if ($redirect_to_safe !== '') {
    $google_login_url .= '?redirect_to=' . urlencode($redirect_to_safe);
}
?>
    ...
    <div class="auth-box">
        ...
        <div class="auth-form-side">
            ...
            <form method="POST" action="<?= BASE_URL ?>/public/proses_login.php">
                ...
                <!-- Tombol Google Login: hanya mengarah ke google-login.php -->
                <a href="<?= htmlspecialchars($google_login_url, ENT_QUOTES, 'UTF-8') ?>" class="btn-google">
